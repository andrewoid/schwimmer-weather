 ...
 * This has been copied from https://github.com/ReactiveX/RxJavaFX
 */
public final class JavaFxScheduler extends Scheduler {
    ...
    private static class JavaFxWorker extends Worker implements Runnable {
        ...
        @Override
        public @NonNull Disposable schedule(final @NonNull Runnable action, long delayTime, TimeUnit unit) {
        ...
        @Override
        public @NonNull Disposable schedule(final @NonNull Runnable action) {
            if (isDisposed()) {
